...
export const catalogSearchTool = tool({
  ...
  parameters: z.object({
    ...
    minYear: z
      .number()
      .nullable()
      .describe("Minimum release year (start of range)"),
    maxYear: z
      .number()
      .nullable()
      .describe("Maximum release year (end of range)"),
    minRating: z
      .number()
      .nullable()
      .describe("Minimum TMDB vote average (0-10)"),
    language: z
      .string()
      .nullable()
      .describe("ISO-639-1 language code (e.g. 'fr', 'ko', 'en')"),
    actors: z
      .array(z.string())
      .nullable()
      .describe("List of actor names to include"),
    directors: z
      .array(z.string())
      .nullable()
      .describe("List of director names to include"),
    sortBy: z
